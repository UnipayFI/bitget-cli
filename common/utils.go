...
// FormatTime renders a time.Time as a UTC string in the project layout. The
// Bitget SDK already decodes API timestamps into time.Time, so this is the
// single place CLI output is made timezone-consistent.
