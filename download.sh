...
REPO="UnipayFI/bitget-cli"
BINARY_NAME="bitget-cli"
...
show_usage() {
    ...
    echo "   export BITGET_API_SECRET=\"your_api_secret\""
...
# Main execution
main() {
    print_info "Starting bitget CLI installation..."
    ...
    print_success "bitget CLI has been successfully installed!"
}
